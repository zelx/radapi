...
class NewController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Users']))
		{
			...
			$model->RegisDate=date("Y-m-d H:i:s");
			$model->Status="1";
			if($model->save()){
				//var_dump($model->Mac);
				...
				self::InsertU("radcheck",$model->Mac,"Auth-Type",":=","Accept");
				self::InsertU("radcheck",$model->Mac,"Expiration",":=",$newexpire);
	...
	{
	$post=Users::model()->findALL("status=1");
