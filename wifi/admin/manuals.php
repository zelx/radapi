...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="10" class="header">
  <tr>
    <td width="6%" align="center"><img src="images/BlackNeonAgua_248.png" alt="" width="59" height="60" /></td>
    <td width="94%"><a href="index2.php?option=manuals">Manuals</a><br />
<span class="normal">คู่มือการใช้งานระบบ</span></td>
    <td width="94%">&nbsp;</td>
  </tr>
</table>
