...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="10" class="header">
  <tr>
    ...
    <td width="94%"><a href="index2.php?option=ap_online">Access Point Status</a><br />
  ...
  if($esito=='on'){
   ...
   $image = "images/apoffline.png";
    ...
    <tr>
      ...
      <td width="170" align="center" valign="top" bgcolor="<?= $bgcolor ?>"><?= $name[$i] ?></td>
      <td width="170" align="center" valign="top" bgcolor="<?= $bgcolor ?>"><?= $ipad[$i] ?></td>
     <td width="170" align="center" valign="top" bgcolor="<?= $bgcolor ?>"><img src="status.php?link=<?= $ipad[$i] ?>" width="35" height="35"></td>
