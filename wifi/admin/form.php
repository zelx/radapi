  ...
  <div id="content">
    ...
    <table width="95%" border="0" cellpadding="0" cellspacing="5" class="admintable">
      <tr>
        ...
        <td align="center" class="key">Block ไฟล์</td>
      </tr>
      <tr>
        <td height="39" align="center"><span class="style1">
          <textarea rows="20" cols="25" name="content">
<?
$fn = "/etc/squid/key.txt";
print htmlspecialchars(implode("",file($fn)));
?> 
      </textarea>
          &nbsp;</span></td>
        <td align="center"><span class="style1">
          <textarea rows="20" cols="25" name="content2">
<?
$fn = "/etc/squid/download.txt";
print htmlspecialchars(implode("",file($fn)));
?> 
      </textarea>
        </span></td>
